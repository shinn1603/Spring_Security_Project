...
import vn.yain.repository.OtpTokenRepository;
import vn.yain.service.EmailService;
import vn.yain.service.OtpService;
...
public class OtpServiceImpl implements OtpService {
    ...
    public void sendRegisterOtp(String email) {
        send(email, "REGISTER", "Yain shop - Xác nhận đăng ký tài khoản");
    }

    @Override
    @Transactional
    public void sendResetPasswordOtp(String email) {
        send(email, "RESET_PASSWORD", "Yain shop - OTP đặt lại mật khẩu");
    }
